/*
react-datetime-header-footer v2.16.0
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Datetime = createClass({
	  ...
	  propTypes: {
	    ...
	    headerClass: TYPES.string,
	    headerValue: TYPES.oneOf([TYPES.string, TYPES.object, TYPES.array]),
	    footerMainClass1: TYPES.string,
	    footerMainClass2: TYPES.string,
	    footerRow: TYPES.oneOf([TYPES.string, TYPES.object, TYPES.element])
	  },
	  ...
	  createClass({
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "th",
	            {
	              className: "rdtSwitch " + this.props.headerClass || "",
	              colSpan: 4
	            },
	    ...
	    renderFooter: function() {
	      ...
	      return React.createElement(
	        ...
	        {
	          key: "hf",
	          className: this.props.footerMainClass1
	            ? this.props.footerMainClass1
	            : null
	        },
	        this.props.footerRow ? this.props.footerRow : null
	      );
	    },
